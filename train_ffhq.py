...
from stylegan2.datasets.ffhq import FFHQ
        ...
        if get_rank() == 0:
            ...
            if i % 100 == 0:
                with torch.no_grad():
                    ...
                    utils.save_image(
                        sample,
                        f"swapping-autoencoder-pytorch/sample_ffhq/{str(i).zfill(6)}.png",
            ...
            if i % 10000 == 0:
                torch.save(
                    ...
                    f"swapping-autoencoder-pytorch/checkpoint_ffhq/{str(i).zfill(6)}.pt",
                )
